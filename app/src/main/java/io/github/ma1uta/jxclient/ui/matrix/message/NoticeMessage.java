 ...
 * Text message.
 */
public class NoticeMessage extends AbstractMessage<Notice> implements Initializable {
    ...
    @Override
    public void parse(RoomMessage<Notice> event, MatrixAccount account) {
        setEvent(event);
        body.setText(event.getContent().getBody());
    }
