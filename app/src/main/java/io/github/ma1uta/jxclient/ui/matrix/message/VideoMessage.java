 ...
 * Text message.
 */
public class VideoMessage extends AbstractMessage<Video> implements Initializable {
    ...
    @Override
    public void parse(RoomMessage<Video> event, MatrixAccount account) {
        setEvent(event);
        body.setText(event.getContent().getUrl());
    }
