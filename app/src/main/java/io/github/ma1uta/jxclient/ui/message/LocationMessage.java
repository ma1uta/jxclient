 ...
 * Text message.
 */
public class LocationMessage extends AbstractMessage<Location> implements Initializable {
    ...
    @Override
    public void parse(RoomMessage<Location> event, MatrixAccount account) {
        setEvent(event);
        body.setText(event.getContent().getGeoUri());
    }
